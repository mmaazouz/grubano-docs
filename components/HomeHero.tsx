...
const COPY = {
  ...
  es: {
    badge: 'Centro de ayuda Grubano',
    icon: 'support_agent',
    title: '¿Cómo podemos ayudarle?',
    subtitle: 'Encuentre respuestas, guías y recursos para todos los espacios de Grubano.',
    placeholder: 'Buscar un artículo, una guía, una pregunta…',
    empty: 'Sin resultados',
    loading: 'Cargando…',
    error: 'No se pudo cargar el índice de búsqueda.',
    popularLabel: 'Popular:',
    popular: [
      { label: 'seguir mi pedido', href: '/es/guides/consumer/' },
      { label: 'métodos de pago', href: '/es/guides/consumer/' },
      { label: 'crear una cuenta', href: '/es/guides/consumer/' },
    ],
  },
  ar: {
    badge: 'مركز مساعدة Grubano',
    icon: 'support_agent',
    title: 'كيف يمكننا مساعدتك؟',
    subtitle: 'اعثر على إجابات وأدلة وموارد لجميع مساحات Grubano.',
    placeholder: 'ابحث عن مقال أو دليل أو سؤال…',
    empty: 'لا توجد نتائج',
    loading: 'جارٍ التحميل…',
    error: 'تعذّر تحميل فهرس البحث.',
    popularLabel: 'الأكثر بحثاً:',
    popular: [
      { label: 'تتبّع طلبي', href: '/ar/guides/consumer/' },
      { label: 'طرق الدفع', href: '/ar/guides/consumer/' },
      { label: 'إنشاء حساب', href: '/ar/guides/consumer/' },
    ],
  },
  it: {
    badge: 'Centro assistenza Grubano',
    icon: 'support_agent',
    title: 'Come possiamo aiutarti?',
    subtitle: 'Trova risposte, guide e risorse per tutti gli spazi Grubano.',
    placeholder: 'Cerca un articolo, una guida, una domanda…',
    empty: 'Nessun risultato',
    loading: 'Caricamento…',
    error: 'Impossibile caricare l’indice di ricerca.',
    popularLabel: 'Più cercati:',
    popular: [
      { label: 'seguire il mio ordine', href: '/it/guides/consumer/' },
      { label: 'metodi di pagamento', href: '/it/guides/consumer/' },
      { label: 'creare un account', href: '/it/guides/consumer/' },
    ],
  },
} as const
